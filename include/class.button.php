			...
			<?php if($options['phone']) { ?>
				<li>
					<a href="tel:<?php echo $options['phone']; ?>" target="_blank">
						...
						<span class="button-hk-contact phone" style="background-color: <?php echo $options['phone_color']; ?>"></span>
						<strong style="background-color: <?php echo $options['phone_color']; ?>"><?php echo $options['phone']; ?></strong>
					</a>
				</li>
			<?php } ?>
